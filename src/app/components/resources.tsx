    ...
    >
      <div className="flex flex-col w-full justify-around">
        ...
        `,
              ...
              className="bg-[#D2BCFF] rounded-[24px] relative flex flex-col justify-between h-[372px] w-[317px] p-3"
            >
        ...
        `,
                ...
                className="bg-[#FFB693] rounded-[24px] flex flex-col p-2 h-[178px] w-[317px] relative"
              >
        ...
        `,
                ...
                className="p-2 rounded-[24px] flex flex-col relative h-[178px] w-[317px]"
              >
                <div className="flex space-x-3 items-center">
